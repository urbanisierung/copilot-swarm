...
| **Auto mode** | 2026-02-18 | `swarm auto` — Combines planning and running in one autonomous pipeline. All clarifying questions are auto-answered with the agent's best judgment. Plan output feeds directly into the run pipeline. Useful for well-defined tasks, CI/CD, or batch processing |
