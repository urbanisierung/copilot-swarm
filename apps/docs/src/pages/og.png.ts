...
function buildSvg(): string {
  ...
  <!-- Tagline -->
  <text x="80" y="215" font-family="sans-serif" font-size="34" font-weight="700" fill="url(#grad)">Documentation</text>

  <text x="80" y="290" font-family="sans-serif" font-size="22" fill="#8888a0">Commands, agents, pipeline configuration,</text>
  <text x="80" y="322" font-family="sans-serif" font-size="22" fill="#8888a0">environment variables, and more.</text>
