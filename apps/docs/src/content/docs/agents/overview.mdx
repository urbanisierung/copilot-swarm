...
Copilot Swarm coordinates **14 specialized agents**, each with a distinct role, tools, and expertise — mirroring a real engineering team.
...
Analyzes and compares two PR implementations side-by-side.

<CardGrid>
  <Card title="Diff Analyst" icon="magnifier">
    Inventories and categorizes changes in a single PR — files, patterns, scope.
  </Card>
  <Card title="Requirements Evaluator" icon="approve-check-circle">
    Scores each PR against requirements using a coverage matrix (✅/⚠️/❌).
  </Card>
  <Card title="Comparative Reviewer" icon="random">
    Head-to-head synthesis — compares approaches and produces a recommendation.
  </Card>
</CardGrid>
